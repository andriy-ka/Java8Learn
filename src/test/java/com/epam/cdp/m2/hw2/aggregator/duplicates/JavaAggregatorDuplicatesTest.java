...
public abstract class JavaAggregatorDuplicatesTest {
    ...
    public static List<Object[]> data() {
        ...
        data.add(new Object[]{3, asList("all", "arguments", "a", "map", "wwwwwww", "map", "arguments", "all"), asList("ALL", "ARGUMENTS", "MAP")});
        data.add(new Object[]{2, asList("dog", "word", "intellij", "a", "b", "dog", "word", "intellij"), asList("DOG", "INTELLIJ")});
